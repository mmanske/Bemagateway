...
WSDL.prototype._initializeOptions = function (options) {
  this.options = {};
  this.options.preserveParamFormat = false;
  if (options && options.preserveParamFormat) {
    this.options.preserveParamFormat =  options.preserveParamFormat;
  }
...
WSDL.prototype.xmlToObject = function(xml) {
  ...
  p.oncdata = function (text) {
    ...
    if (/<\?xml[\s\S]+\?>/.test(text) && !self.options.preserveParamFormat) {
